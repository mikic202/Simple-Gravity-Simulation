...
third_object_v = Vector(0.0, 0.05)


class Window:
    def __init__(self) -> None:
        self._WIN = pygame.display.set_mode((start_width, start_height))
        self._objects = {MassObject("a", 10, first_object_pos, first_object_v), MassObject("b", 10, second_object_pos, second_object_v), MassObject("c", 10, third_object_pos, third_object_v)}
